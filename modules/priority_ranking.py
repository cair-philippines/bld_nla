...
from analysis import _segment_label, _build_segment_pairs, SCHOOL_YEAR_CHAINS
...
def compute_priority_ranking(
    ...
    segment_idx : int
        0-based index of the segment in the segment pairs list
        generated by ``_build_segment_pairs()``.
    time_chain : list of tuples, optional
        Deprecated — kept for backward compatibility. Ignored when
        *school_year_chains* is provided.
    ...
    school_year_chains : dict, optional
        Per-school-year chain definition. Defaults to
        ``SCHOOL_YEAR_CHAINS``.
    ...
    t0, t1 = segment_pairs[segment_idx]
    seg_n = segment_idx + 1
